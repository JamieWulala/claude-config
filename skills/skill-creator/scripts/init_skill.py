...
Patterns can be mixed and matched as needed. Delete this section when done.]
...
Asset files are NOT loaded into context, but used within the output Claude produces.
